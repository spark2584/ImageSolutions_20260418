<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ThemeSetting.ascx.cs" Inherits="ImageSolutionsWebsite.Controls.ThemeSetting" %>
<!-- theme setting -->
                        ...
                        <div class="col-md-4 col-6 text-center demo-effects">
                            <div class="set-position">
                                ...
                                <a href="vegetables-4.html" class="demo-text">
                                    <h4>Vegetables 4 <span>New</span><h4>
                                </a>
                            </div>
                        </div>
                        <div class="col-md-4 col-6 text-center demo-effects">
                            <div class="set-position">
                                ...
                                <a href="vegetables-5.html" class="demo-text">
                                    <h4>Vegetables 5 <span>New</span><h4>
                                </a>
                            </div>
                        </div>
                        <div class="col-md-4 col-6 text-center demo-effects">
