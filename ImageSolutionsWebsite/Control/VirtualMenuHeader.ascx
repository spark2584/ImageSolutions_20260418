<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="VirtualMenuHeader.ascx.cs" Inherits="ImageSolutionsWebsite.Control.VirtualMenuHeader" %>
<ul id="main-menu" class="sm pixelstrap sm-horizontal">
    ...
    <%--<li class='mega' id='hover-cls'>
        <a href='/itemlist.aspx?WebsiteTabID=215'>Apparel</a>
                        ...
                        <div class="col mega-box">
                            <div class="link-section">
                                <div class="menu-content">
                                    <ul>
                                        <li><a target="_blank" href="invoice-1.html">invoice 1</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
