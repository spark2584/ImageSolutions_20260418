<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AccountSearchModal.ascx.cs" Inherits="ImageSolutionsWebsite.Control.AccountSearchModal" %>
<!--modal popup start-->
                                    ...
                                    <div class="card dashboard-table mt-0">
                                        <div class="card-body table-responsive-sm">
                                            <div class="top-sec" id="filter" runat="server" visible="true">
                                                Store Number:&nbsp;<asp:TextBox ID="txtAccountName" runat="server" placeholder="account name" AutoPostBack="true" OnTextChanged="txtAccountName_TextChanged"></asp:TextBox>&nbsp;
