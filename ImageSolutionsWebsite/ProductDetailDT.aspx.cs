...
{
    public partial class ProductDetailDT : BasePageUserAccountAuth
    {
        ...
        public void InitializePage()
        {
            try
            {
                if (_Item == null || _Item.ItemWebsites == null || !_Item.ItemWebsites.Exists(x => x.WebsiteID == CurrentWebsite.WebsiteID))
                {
                    Response.Redirect(String.Format("/myaccount/dashboard.aspx"));
                }

                if (_Item.DefaultSelectableLogo)
                {
                    _Item.EnableSelectableLogo = true;
                }
                ...
                if (!string.IsNullOrEmpty(_MyGroupItem.Item.DisplayImageURL))
                {
                    ...
                    imgItem1.Src = imgItem.ImageUrl;
                    imgItem1_swatch.Src = imgItem1.Src;
                    imgItem2.Src = _MyGroupItem.Item.ImageURL2;
                    imgItem2_swatch.Src = imgItem2.Src;
                    divImgItem2.Visible = !string.IsNullOrEmpty(imgItem2.Src);
                    divImgItem2_swatch.Visible = !string.IsNullOrEmpty(imgItem2.Src);
                    imgItem3.Src = _MyGroupItem.Item.ImageURL3;
                    imgItem3_swatch.Src = imgItem3.Src;
                    divImgItem3.Visible = !string.IsNullOrEmpty(imgItem3.Src);
                    divImgItem3_swatch.Visible = !string.IsNullOrEmpty(imgItem3.Src);
                }
                else
                {
                ...
                if (_Item.DefaultSelectableLogo)
                {
                    ...
                    foreach (RepeaterItem _Item in rptSelectableLogo.Items)
                    {
                        HtmlControl liSelected = (HtmlControl)_Item.FindControl("liSelected");
                        LinkButton lbnSelectableLogo = (LinkButton)_Item.FindControl("lbnSelectableLogo");
                        liSelected.Style.Add("border", "5px solid red");

                        hfSelectedLogo.Value = lbnSelectableLogo.CommandArgument.ToString();
                        chkNoLogo.Visible = false;
                        btnAddMore.Visible = false;

                        imgItem1_swatch.Visible = false;
                        imgItem2_swatch.Visible = false;
                        imgItem3_swatch.Visible = false;
                    }

                    phCustomization.Visible = false;
                }
            }
            catch (Exception ex)
            {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(hfSelectedGroupByAttributeValueID.Value))
                {
                    foreach (ImageSolutions.Item.ItemSelectableLogo _ItemSelectableLogo in _Item.ItemSelectableLogos)
                    {
                        ...
                        {
                            if (_ItemSelectableLogo.WebsiteGroupItemSelectableLogos != null && _ItemSelectableLogo.WebsiteGroupItemSelectableLogos.Count > 0)
                            {
                                foreach (ImageSolutions.User.UserAccount _UserAccount in CurrentUser.CurrentUserWebSite.UserAccounts)
                                {
                                    ImageSolutions.Website.WebsiteGroupItemSelectableLogo WebsiteGroupItemSelectableLogo = new ImageSolutions.Website.WebsiteGroupItemSelectableLogo();
                                    ...
                                    WebsiteGroupItemSelectableLogoFilter.WebsiteGroupID = new Database.Filter.StringSearch.SearchFilter();
                                    WebsiteGroupItemSelectableLogoFilter.WebsiteGroupID.SearchString = Convert.ToString(_UserAccount.WebsiteGroupID);
                                    WebsiteGroupItemSelectableLogo = ImageSolutions.Website.WebsiteGroupItemSelectableLogo.GetWebsiteGroupItemSelectableLogo(WebsiteGroupItemSelectableLogoFilter);

                                    if (WebsiteGroupItemSelectableLogo != null)
                                    {
            ...
            foreach (RepeaterItem _Item in rptItems.Items)
            {
                ...
                if (pnlLengthWidthAttribute.Visible)
                {
                    ...
                    if(!string.IsNullOrEmpty(mSelectedGroupByAttributeValueID))
                    {
                        ...
                        txtLengthWidthAttributeQuantity.Enabled = Item != null && (Item.AvailableInventory > 0 || Item.AllowBackOrder);
                ...
                else if (pnlNoAttribute.Visible)
                {
                    ...
                    txtQuantity.Enabled = objItem != null && (objItem.AvailableInventory > 0 || objItem.AllowBackOrder);
                ...
                else if (pnlNoGroup.Visible)
                {
                    ...
                    txtNoGroupAttributeQuantity.Enabled = Item != null && (Item.AvailableInventory > 0 || Item.AllowBackOrder); 
                            ...
                            if (CurrentWebsite.ProductDetailDisplayType == "Grid")
                            {
                                ...
                                foreach (RepeaterItem _ListRepeaterItem in rptGroupAttribute.Items)
                                {
                                    ...
                                    if (Item != null)
                                    {
                                        ...
                                        imgItem2.Src = Item.ImageURL2;
                                        imgItem2_swatch.Src = imgItem2.Src;
                                        divImgItem2.Visible = !string.IsNullOrEmpty(imgItem2.Src);
                                        divImgItem2_swatch.Visible = !string.IsNullOrEmpty(imgItem2.Src);

                                        imgItem3.Src = Item.ImageURL3;
                                        imgItem3_swatch.Src = imgItem3.Src;
                                        divImgItem3.Visible = !string.IsNullOrEmpty(imgItem3.Src);
                                        divImgItem3_swatch.Visible = !string.IsNullOrEmpty(imgItem3.Src);

                                        //if (Item.ItemNumber.StartsWith("DT100N-TM1WX002-BBHT"))
                                        //{
                                        //    imgItem3.Src = "/assets/company/discounttire/images/DT100N-TM1WX002-BBHT-Back.jpg";
                                        //    imgItem3_swatch.Src = imgItem3.Src;
                                        //}
                                        //else if (Item.ItemNumber.StartsWith("DT100N-TM1WX002-QSGBK"))
                                        //{
                                        //    imgItem3.Src = "/assets/company/discounttire/images/DT100N-TM1WX002-QSGBK-Back.jpg";
                                        //    imgItem3_swatch.Src = imgItem3.Src;
                                        //}
                                        //if (Item.ItemNumber.StartsWith("DT100N-TM1WX002-VIBL"))
                                        //{
                                        //    imgItem3.Src = "/assets/company/discounttire/images/DT100N-TM1WX002-VIBL-Back.jpg";
                                        //    imgItem3_swatch.Src = imgItem3.Src;
                                        //}
                                        //if (Item.ItemNumber.StartsWith("DT100N-TM1WX002-BK"))
                                        //{
                                        //    imgItem3.Src = "/assets/company/discounttire/images/DT100N-TM1WX002-BK-Back.jpg";
                                        //    imgItem3_swatch.Src = imgItem3.Src;
                                        //}
                                        //if (Item.ItemNumber.StartsWith("DT100N-TM1WX002-QSGH"))
                                        //{
                                        //    imgItem3.Src = "/assets/company/discounttire/images/DT100N-TM1WX002-QSGH-Back.jpg";
                                        //    imgItem3_swatch.Src = imgItem3.Src;
                                        //}
                                    }
                                    txtGroupAttributeQuantity.Enabled = Item != null && (Item.AvailableInventory > 0 || Item.AllowBackOrder) && !Item.InActive && Item.IsOnline;

                                    Label lblUnitPrice = (Label)_ListRepeaterItem.FindControl("lblGroupAttributeUnitPrice");
                                    lblUnitPrice.Text = (Item != null && !string.IsNullOrEmpty(Item.ItemID)) ? String.Format("{0:c}", Item.BasePrice) : string.Empty;

                                    if (Item != null && !string.IsNullOrEmpty(Item.ItemID) && Item.DiscountAmount != null && Item.DiscountAmount > 0)
                                    {
                                        Literal litDiscountPrice = (Literal)_ListRepeaterItem.FindControl("litDiscountPrice");
                                        litDiscountPrice.Text = String.Format(@"
<span style='color: red; font-size: x-small; white-space: pre-line;'>
Discount {0:C}
Applied at Checkout
</span>"
    , Item.DiscountAmount);
    ...
    , Item.DiscountAmount);
            ...
            try
            {
                ...
                foreach (RepeaterItem _Item in this.rptItems.Items)
                {
                    ...
                    if (txtQuantity != null && !string.IsNullOrEmpty(txtQuantity.Text) && Convert.ToInt32(txtQuantity.Text) > 0)
                    {
                        ...
                        if (!MyGroupItemWebsite.Item.AllowBackOrder && newShoppingCartLine.Quantity > decAvailable)
                        {
                ...
                if(gotoshoppingcart)
                {
                    if(CurrentWebsite.ReloadAfterAddToCart)
                    {
                        Response.Redirect(String.Format("{0}&reload=1", Convert.ToString(Request.Url)));
                    }
                    else
                    {
        ...
        protected void GenerateImage(ImageSolutions.Item.ItemSelectableLogo itemselectedlogo)
        {
            ...
            else
            {
                ...
                {
                    imgItem.ImageUrl = "../assets/images/pro3/2.jpg";
                    imgItem1.Src = "../assets/images/pro3/2.jpg";
                }
            }            
        }
                        ...
                        if (ItemPersonalization.DefaultValue == "First Name")
                        {
                            if (phEmployee.Visible && !string.IsNullOrEmpty(ddlUserInfo.SelectedValue))
                            {
                                ...
                                if(UserWebsite.IsStore)
                                {
                                    ...
                                    ddlTextOption.Items.Insert(0, new ListItem("No Embroidery", "NoEmbroidery"));
                                    txtTextOption.Visible = false;
                                }
                                else
                                {
        ...
        protected void ddlTextOption_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (
                ddlTextOption.SelectedItem.Text == "Preferred Name"
                && (
                    (Convert.ToString(ConfigurationManager.AppSettings["Environment"]).ToLower() == "staging" && CurrentWebsite.WebsiteID == "48")
                    || (Convert.ToString(ConfigurationManager.AppSettings["Environment"]).ToLower() == "production" && CurrentWebsite.WebsiteID == "9")
                )
            )
            {
                if (phEmployee.Visible && !string.IsNullOrEmpty(ddlUserInfo.SelectedValue))
                {
                    ...
                    txtTextOption.Text = string.IsNullOrEmpty(UserInfo.DisplayName) ? UserInfo.FirstName : UserInfo.DisplayName;
                }
                else
                {
                    txtTextOption.Text = string.IsNullOrEmpty(CurrentUser.DisplayName) ? CurrentUser.FirstName : CurrentUser.DisplayName;
                }
        ...
        protected void gvGroupAttribute_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            string strItemID = e.CommandArgument.ToString();
            ucSuperceedingItem.ItemID = strItemID;
            ucSuperceedingItem.Show();
