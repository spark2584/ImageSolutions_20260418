<%@ Page Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="CustomizationField.aspx.cs" Inherits="ImageSolutionsWebsite.Admin.CustomizationField" %>
...
<asp:Content ID="cBody" ContentPlaceHolderID="cphBody" runat="server">
    ...
    <table style="width:100%; border:solid">
        ...
        <tr>
            ...
            <td style="text-align:right">
                <asp:Button ID="btnDelete" runat="server" Text="Delete Group" OnClick="btnDelete_Click" />
            </td>
        </tr>
        <tr>
            <td colspan="2">
    ...
    <table style="width:100%; border:solid">
        ...
        <tr>
            <td>
                <asp:Button ID="btnAddFieldValue" runat="server" Text="Add Value" OnClick="btnAddFieldValue_Click" />
            </td>
        </tr>
        <tr>
            <td>
                <asp:GridView runat="server" ID="gvCustomizationFieldValue" AutoGenerateColumns="False" Width="100%" AllowSorting="true" CellSpacing="0" CellPadding="0"
                    OnRowCommand="gvCustomizationFieldValue_RowCommand">
                    <Columns>
                        <asp:BoundField DataField="Value" HeaderText="Value" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="80%" />
                        <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                            <ItemTemplate>
                                <asp:Button runat="server" ID="btnLineRemove" Text="Remove" CommandName="LineRemove" CommandArgument='<%# Eval("CustomizationFieldValueID") %>' CausesValidation="false" Width="100%"/>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
