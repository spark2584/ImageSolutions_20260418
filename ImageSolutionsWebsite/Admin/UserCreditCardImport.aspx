<%@ Page Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="UserCreditCardImport.aspx.cs" Inherits="ImageSolutionsWebsite.Admin.UserCreditCardImport" %>
                                            ...
                                            <div class="table-responsive-xl">
                                                ...
                                                <div>
                                                    <asp:GridView runat="server" ID="gvUserUpload" AutoGenerateColumns="False" CssClass="table cart-table order-table" HeaderStyle-CssClass="table-head" GridLines="None" Width="100%" AllowSorting="true" CellSpacing="0" CellPadding="0">
                                                        <Columns>
                                                            <asp:BoundField DataField="UserCreditCardID" HeaderText="ID" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
                                                            ...
                                                            <asp:BoundField DataField="Limit" HeaderText="Set Limit" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
                                                            <asp:BoundField DataField="IsActive" HeaderText="Active" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
                                                        </Columns>
                                                    </asp:GridView>
