<%@ Page Language="C#" MasterPageFile="~/MasterPage.Master"  AutoEventWireup="true" CodeBehind="ItemAttribute.aspx.cs" Inherits="ImageSolutionsWebsite.Admin.ItemAttribute" %>
                                        ...
                                        <ul class="nav nav-tabs nav-material" id="top-tab" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active" id="top_1_tab" runat="server" data-bs-toggle="tab"
                                                    ...
                                                    <i class="icofont icofont-ui-home"></i>Attribute Information
                                                </a>
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" id="top_2_tab" runat="server" data-bs-toggle="tab"
                                                    ...
                                                    <i class="icofont icofont-man-in-glasses"></i>Attribute Values
                                                </a>
                                                <div class="material-border"></div>
                                            </li>
                                        </ul>
                                                ...
                                                <div class="col-12">
                                                    <div class="card dashboard-table mt-0">
                                                        <div class="card-body table-responsive-sm">
                                                            <div class="top-sec">
                                                                <h3></h3>
                                                                <a href="/admin/itemattributevalue.aspx?attributeid=<%= mAttributeID %>" class="btn btn-sm btn-solid">+ add new</a>
                                                            </div>
                                                            <div class="table-responsive-xl">
                                                                <asp:GridView runat="server" ID="gvAttributeValue" DataKeyNames="AttributeValueID" OnRowCommand="gvAttributeValue_RowCommand" OnRowDataBound="gvAttributeValue_RowDataBound" AutoGenerateColumns="False" CssClass="table cart-table order-table" HeaderStyle-CssClass="table-head" GridLines="None" Width="100%" AllowSorting="true" CellSpacing="0" CellPadding="0">
                                                                    <Columns>
                                                                        <asp:BoundField DataField="Value" HeaderText="Value" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
                                                                        <asp:BoundField DataField="Abbreviation" HeaderText="Abbreviation" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
                                                                        <asp:BoundField DataField="BackgroundColor" HeaderText="Background Color" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
                                                                        <asp:TemplateField>
                                                                            <ItemTemplate>
                                                                                <asp:HiddenField ID="hfAttributeValueID" runat="server" Value='<%# Eval("AttributeValueID") %>' />
                                                                                <asp:Button ID="btnUp" runat="server" Text="Up" CommandArgument='<%# Eval("AttributeValueID") %>' CommandName="MoveUp" />
                                                                                <asp:Button ID="btnDown" runat="server" Text="Down" CommandArgument='<%# Eval("AttributeValueID") %>' CommandName="MoveDown"/>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>
                                                                        ...
                                                                        <asp:CheckBoxField DataField="IsDefault" HeaderText="Default" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" />
                                                                        ...
                                                                        <asp:TemplateField HeaderText="VIEW">
                                                                            <ItemTemplate>
                                                                                <a href='/admin/itemattributevalue.aspx?id=<%# Eval("AttributeValueID") %>'>
