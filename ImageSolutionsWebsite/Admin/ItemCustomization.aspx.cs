...
{
    public partial class ItemCustomization : BasePageAdminUserWebSiteAuth
    {
        protected string mItemID = "1";

        protected void Page_Load(object sender, EventArgs e)
        {
            imgResult.ImageUrl = "/DragAndDrop/RaisingCane-Front.jpg?t=" + DateTime.Now.ToLongTimeString();
        }
        ...
        protected void btnGenerate_Click(object sender, EventArgs e)
        {
            ...
            if (ddlPosition.SelectedValue == "back")
                imgSource = new Bitmap(strPath + "RaisingCane-Back.jpg");
            else 
                imgSource = new Bitmap(strPath + "RaisingCane-Front.jpg");
            ...
            imgResult.ImageUrl = "/DragAndDrop/result.jpg?t=" + DateTime.Now.ToLongTimeString();
        }
        ...
        protected void ddlLogo_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                imgUplodaedLogo.ImageUrl = "/DragAndDrop/LogoUpload/OneLove.png";
            }
            else if (ddlLogo.SelectedValue == "Logo2")
            {
                imgUplodaedLogo.ImageUrl = "/DragAndDrop/LogoUpload/CanesCrew.png";
            }
            else if (ddlLogo.SelectedValue == "Logo3")
            {
                imgUplodaedLogo.ImageUrl = "/DragAndDrop/LogoUpload/Swirl.png";
            }
            btnGenerate_Click(null, null);
        }
    }
