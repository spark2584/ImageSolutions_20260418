<%@ Page Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="GroupTab.aspx.cs" Inherits="ImageSolutionsWebsite.Admin.GroupTab" %>
                                                ...
                                                <div class="theme-form">
                                                    <div class="form-row row">
                                                        <div class="col-md-12">
                                                            ...
                                                            <asp:RequiredFieldValidator ID="valGroup" runat="server" ControlToValidate="ddlGroup" ValidationGroup="Group" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                                        </div>
                                                        <div class="col-md-12">
