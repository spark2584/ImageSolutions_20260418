<%@ Page Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ItemAttributeValue.aspx.cs" Inherits="ImageSolutionsWebsite.Admin.ItemAttributeValue" %>
                                                ...
                                                <div class="theme-form">
                                                    <div class="form-row row">
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <asp:TextBox ID="txtAbbreviation" runat="server" CssClass="form-control" placeholder="abbreviation" required=""></asp:TextBox>
                                                            <br />
                                                        </div>
                                                        <div class="col-md-12">
                                                            <label>Background Color</label>
                                                            <asp:TextBox ID="txtBackgroundColor" runat="server" CssClass="form-control" placeholder="abbreviation" required=""></asp:TextBox>
                                                            <br />
                                                        </div>
                                                        <div class="col-md-12">
                                                            <label>Is Default</label>
                                                            <asp:CheckBox ID="cbIsDefault" runat="server" /><br /><br />
                                                        </div>
                                                        <div class="col-md-12">
