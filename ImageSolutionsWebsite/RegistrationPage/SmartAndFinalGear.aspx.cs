...
{
    public partial class SmartAndFinalGear : BasePageUserNoAuth
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!CurrentWebsite.IsLoggedIn || !CurrentWebsite.UserRegistration) Response.Redirect("/login.aspx");

            if (CurrentWebsite.WebsiteID != "19") Response.Redirect("/login.aspx");
        ...
        {
            string strAccountID = "27561";  
            string strGroupID = "185"; 
