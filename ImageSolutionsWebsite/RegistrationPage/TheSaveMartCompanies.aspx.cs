...
{
    public partial class TheSaveMartCompanies : BasePageUserNoAuth
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!CurrentWebsite.IsLoggedIn || !CurrentWebsite.UserRegistration) Response.Redirect("/login.aspx");

            if(CurrentWebsite.WebsiteID != "15") Response.Redirect("/login.aspx");
        ...
        {
            string strAccountID = "26422";  //The Save Mart Employee Purchase
            string strGroupID = "167"; //The Save Mart Employee Purchase Dynamic Group
