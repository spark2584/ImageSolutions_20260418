<%@ Page Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="TimHortons.aspx.cs" Inherits="ImageSolutionsWebsite.RegistrationPage.TimHortons" %>
                    ...
                    <div class="theme-card">
                        <div class="theme-form">
                            <div class="form-group">
                                <label for="ddlAccount">Franchisee</label>
                            ...
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddlType" runat="server" CssClass="form-control form-select-sm form-select" OnSelectedIndexChanged="ddlType_SelectedIndexChanged" AutoPostBack="true">
                                    <asp:ListItem Text="Restaurant" Value="Store" />
                                    <asp:ListItem Text="Franchisee Owner" Value="FranchiseeOwner" />
                                </asp:DropDownList>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="ddlType" ValidationGroup="register" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>     
                            </div>
                            <asp:Panel ID="pnlRestNo" runat="server">
                                <div class="form-group">
                                    <label for="txtRestNo">Rest #</label>
                                    <asp:TextBox ID="txtRestNo" runat="server" ValidationGroup="register" CssClass="form-control" placeholder="Rest #"></asp:TextBox>
                                </div>
                            </asp:Panel>
                            <div class="form-group">
