<%@ Page Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ABSCompaniesUniforms.aspx.cs" Inherits="ImageSolutionsWebsite.HomePage.ABSCompaniesUniforms" %>
                ...
                <%--<a href="/items.aspx?WebsiteTabID=1621">  --%>              
                    <div>
                        <div class="home text-center">
                            <asp:Image ID="imgHomePage" runat="server" ImageUrl="../assets/company/Albertsons/Carousel/20251217/Albertsons_Desktop.jpg" AlternateText="" class="bg-img blur-up lazyload" Width="100%" />
                            <div class="container">
                                <div class="row">
                                    <div class="col">
        ...
        <div class="item-mobile">
            <div class="slide-1 home-slider" id="slides2">
                ...
                <%--<a href="/items.aspx?WebsiteTabID=1904"> --%>               
                    <div>
                        <div class="home text-center">
                            <asp:Image ID="imgHomePageMobile" runat="server" ImageUrl="../assets/company/Albertsons/Carousel/20251217/Albertsons_Mobile.jpg" AlternateText="" class="bg-img blur-up lazyload" />
