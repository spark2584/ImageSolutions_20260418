IronXL is the Excel Library for .NET to read, generate and edit Excel (and other Spreadsheet files) in .NET projects. IronXL supports .NET 8, .NET 7, .NET 6, .NET 5, Core, Standard & Framework without the need to install MS Office or Excel Interop.
...
========================
* C#, F#, and VB.NET
* .NET 8, .NET 7, .NET 6, .NET 5, Core 2x & 3x, and Framework 4.6.2
