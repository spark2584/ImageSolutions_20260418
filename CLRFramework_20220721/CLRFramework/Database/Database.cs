...
public partial class Database
{
    ...
    //private static string m_SSHPrivateKey = SSHPrivateKey;
    //private static string m_SSHHostName = SSHHostName;
    //private static string m_SSHUserName = SSHUserName;
    //private static string m_SQLHostName = SQLHostName;

    //public static string SSHPrivateKey
    //{
    //    get
    //    {
    //        if (ConfigurationManager.AppSettings["SSHPrivateKey"] != null && !string.IsNullOrEmpty(ConfigurationManager.AppSettings["SSHPrivateKey"]))
    //            return Convert.ToString(ConfigurationManager.AppSettings["SSHPrivateKey"]);
    //        else
    //            return string.Empty;
    //    }
    //}
    ...
    //    get
    //    {
    //        if (ConfigurationManager.AppSettings["SSHHostName"] != null && !string.IsNullOrEmpty(ConfigurationManager.AppSettings["SSHHostName"]))
    //            return Convert.ToString(ConfigurationManager.AppSettings["SSHHostName"]);
    //        else
    //            return string.Empty;
    //    }
    //}
    ...
    //    get
    //    {
    //        if (ConfigurationManager.AppSettings["SSHUserName"] != null && !string.IsNullOrEmpty(ConfigurationManager.AppSettings["SSHUserName"]))
    //            return Convert.ToString(ConfigurationManager.AppSettings["SSHUserName"]);
    //        else
    //            return string.Empty;
    //    }
    //}
    ...
    //    get
    //    {
    //        if (ConfigurationManager.AppSettings["SQLHostName"] != null && !string.IsNullOrEmpty(ConfigurationManager.AppSettings["SQLHostName"]))
    //            return Convert.ToString(ConfigurationManager.AppSettings["SQLHostName"]);
    //        else
    //            return string.Empty;
    //    }
    //}
    ...
    //    get
    //    {
    //        if (ConfigurationManager.AppSettings["SQLPort"] != null && !string.IsNullOrEmpty(ConfigurationManager.AppSettings["SQLPort"]))
    //            return Convert.ToString(ConfigurationManager.AppSettings["SQLPort"]);
    //        else
    //            return string.Empty;
    //    }
    //}
    ...
    public static string DefaultConnectionString
    {
        get
        {
            ...
            using (StreamReader reader = new StreamReader(AppDomain.CurrentDomain.BaseDirectory + "appsettings.json"))
            {
                AppSettings = JsonConvert.DeserializeObject<AppSettings>(reader.ReadToEnd());
            }

            return AppSettings.ConnectionStrings.Default;
    ...
    public static SqlDataReader GetDataReader(string strSQL, string strConnectionString)
    {
        ...
        //if (!string.IsNullOrEmpty(SSHPrivateKey) && !string.IsNullOrEmpty(SSHUserName) && !string.IsNullOrEmpty(SSHHostName) && !string.IsNullOrEmpty(SQLHostName))
        //{
        //    PrivateKeyFile objPrivateKey = null;
        //    ForwardedPortLocal objPort = null;

        //    try
        //    {
        //        objPrivateKey = new PrivateKeyFile(SSHPrivateKey);
        //        using (var client = new SshClient(SSHHostName, SSHUserName, objPrivateKey))
        //        {
        //            client.Connect();
        //            client.ConnectionInfo.Timeout = TimeSpan.FromSeconds(120);
        //            objPort = new ForwardedPortLocal("127.0.0.1", 3433, SQLHostName, 3433);
        //            client.AddForwardedPort(objPort);
        //            objPort.Start();
        //            objConn = new SqlConnection(strConnectionString);
        //            objConn.Open();
        //            objComm = new SqlCommand(strSQL, objConn);
